...
class CharactorDurationF0EnergyMelDataset(AbstractDataset):
    ...
    def __init__(
        ...
        assert True, f"---------------mel: ${len(mel_files)} ---------------"
        assert True, f"---------------char: ${len(charactor_files)} ---------------"
        assert True, f"---------------dur: ${len(duration_files)} ---------------"
        assert True, f"---------------f0: ${len(f0_files)} ---------------"
        assert True, f"---------------energy: ${len(energy_files)} ---------------"
        assert (
            len(mel_files)
            == len(charactor_files)
            == len(duration_files)
